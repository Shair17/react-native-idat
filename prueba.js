...
function agregarTransaccion(descripcion, monto, tipo) {
	registroMes.push({
		descripcion,
		monto,
		tipo,
...
// Egresos e Ingresos
agregarTransaccion('Ingreso de salario', 2000, 'ingreso');
agregarTransaccion('Compra en supermercado', 150, 'egreso');
agregarTransaccion('Pago de alquiler', 800, 'egreso');
agregarTransaccion('Ingreso de bono', 500, 'ingreso');
agregarTransaccion('Compra en tienda', 50, 'egreso');
